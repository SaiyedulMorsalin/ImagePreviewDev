...
namespace Image_Preview.Controls
{
    public partial class mybtn : UserControl
    {
        ...
        public void button3_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show($"displaying image '{filepath.FullName}'", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            Current = filepath.FullName;
        ...
        public string CurrentItemPath(string path)
        {
            return path + " Click Item";
        }
